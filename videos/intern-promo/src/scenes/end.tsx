import { Animate, Chime, Img, Pad, Sequence, staticFile, useSpring } from "@archastro/clapper-core";
    ...
    <Dark>
      ...
      >
        ...
        >
          ...
          />
          <span
            style={{ fontSize: 116, fontWeight: 600, letterSpacing: "-0.02em", color: "var(--dark-ink)" }}
          >
            Intern
          </span>
        </div>
        ...
        <Rise
          ...
          duration={26}
          className="display"
          style={{ fontSize: 60, fontStyle: "italic", color: "var(--dark-muted)" }}
        >
