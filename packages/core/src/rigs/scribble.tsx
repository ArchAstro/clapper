import { Rough, RoughEllipse, roughPath, useBoil, type SketchPt } from "../sketch";
...
const base: ScribblePose = { hx: 0, hy: 0, tilt: 0, lean: 0, lhx: -92, lhy: -16, rhx: 92, rhy: -16, eyes: 1, brow: 0, mouth: 0.25, open: 0, sweat: 0, pupil: 0.5 };
...
export type ScribblePoseKey = { at: Frames; pose: ScribblePoseName | ScribblePose; ease?: "linear" | "outBack" | "inOutCubic" | "outExpo" | "outQuint"; arc?: number };

export function useScribblePose(keys: ScribblePoseKey[], offset: Frames = 0): ScribblePose {
  return usePoseCore(SCRIBBLE_POSES, keys, { arcChannels: [["lhx", "lhy"], ["rhx", "rhy"]], offset });
}
...
export function Scribble({ pose, x = 0, y = 0, scale = 1, typing = 0, fury = 0, desk = true, ink = INK, paper = PAPER, blinkPeriod = 97, style }: { pose: ScribblePose; x?: number; y?: number; scale?: number; typing?: number; fury?: number; desk?: boolean; ink?: string; paper?: string; /** frames between blinks */ blinkPeriod?: number; style?: CSSProperties }) {
