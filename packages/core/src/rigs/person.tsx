...
const base: PersonPose = { headTurn: 0, headTilt: 6, headRoll: 0, lean: 3, slump: 0, shoulders: 0, lhx: -104, lhy: -16, rhx: 104, rhy: -16, eyes: 0.95, pupilX: 0, pupilY: 0.3, brow: 0, mouth: 0.1, mouthOpen: 0 };
...
export type PersonPoseKey = { frame?: number; at?: Frames; pose: PersonPose | PersonPoseName; easing?: EasingFn; arc?: number };

const ARC_CHANNELS: [keyof PersonPose & string, keyof PersonPose & string][] = [["lhx", "lhy"], ["rhx", "rhy"]];
