...
- Packaging verified: v0.3.0-dev.1 Apple Silicon standalone, actual npm global install and npx tarballs pass. Installed launcher discovers all 75 presets and renders a TS score with fresh glockenspiel samples. Runtime manifests rewrite internal workspace dependencies to versions, while the project uses portable file dependencies.
